...
public class JdbcDaoSupport extends org.springframework.jdbc.core.support.JdbcDaoSupport implements MahasiswaDao {
    ...
    public boolean insert(Mahasiswa mahasiswa) {
        return getJdbcTemplate().update(INSERT, new Object[]
